    ...
    <main className="max-w-4xl mx-auto px-6 py-16 grid gap-12">
      <section className="text-center space-y-6">
        ...
        <p className="text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Campus directory for restaurants, hostels, travel, services, and
      ...
      <section className="glass border border-emerald-400 bg-emerald-50/20 rounded-xl p-6 text-center">
        <p className="text-lg flex items-center justify-center gap-3">
          ...
          <span className="font-medium text-emerald-400">
            Try the Mail to Warden for Leave feature
          </span>
          <Link
            href="/tools/mail-to-warden"
            className="ml-2 text-emerald-400 hover:text-emerald-500 underline font-medium"
          >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/academics">
          <div className="group p-8 rounded-2xl border bg-card hover:bg-accent/50 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
            ...
            <p className="text-base text-muted-foreground">
              Academic systems, resources and portals
            </p>
          </div>
        </Link>
        <Link href="/restaurants">
          <div className="group p-8 rounded-2xl border bg-card hover:bg-accent/50 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
            ...
            <p className="text-base text-muted-foreground">
              Menus, timings, delivery and contacts
            </p>
          </div>
        </Link>
        <Link href="/hostels">
          <div className="group p-8 rounded-2xl border bg-card hover:bg-accent/50 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
            ...
            <p className="text-base text-muted-foreground">
              Wardens and contacts per block
            </p>
          </div>
        </Link>
        <Link href="/travel">
        ...
        <Link href="/tools">
          <div className="group p-8 rounded-2xl border bg-card hover:bg-accent/50 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
            ...
            <p className="text-base text-muted-foreground">
              Campus map, mess menus, and resources
            </p>
          </div>
        </Link>
        <Link href="/emergency">
